...
function findNonFullSpawnOrExtensionAction() {
    this.preconditions = [];
    this.postconditions = [
        new goapState.state(constants.STATE_ACTOR_FOUND_NON_FULL_SPAWN_OR_EXTENSION, true)
    ];
    this.cost = 3;
...
function findNonEmptySpawnOrExtensionAction() {
    this.preconditions = [];
    this.postconditions = [
        new goapState.state(constants.STATE_ACTOR_FOUND_NON_EMPTY_SPAWN_OR_EXTENSION, true)
    ];
    this.cost = 3;
...
function harvestSourceAction() {
    this.preconditions = [
        new goapState.state(constants.STATE_ACTOR_FOUND_ACTIVE_SOURCE, true),
        new goapState.state(constants.STATE_ACTOR_FULL_ENERGY, false),
        new goapState.state(constants.STATE_ACTOR_HAS_CARRY, true),
        new goapState.state(constants.STATE_ACTOR_HAS_WORK, true)
    ];
    this.postconditions = [
        new goapState.state(constants.STATE_ACTOR_NO_ENERGY, false),
        new goapState.state(constants.STATE_ACTOR_FULL_ENERGY, true)
    ];
    this.cost = 1;
...
function withdrawEnergyFromSpawnOrExtensionAction() {
    this.preconditions = [
		new goapState.state(constants.STATE_ACTOR_FOUND_NON_EMPTY_SPAWN_OR_EXTENSION, true),
        new goapState.state(constants.STATE_ROOM_HAS_ENERGY, true),
        new goapState.state(constants.STATE_ACTOR_FULL_ENERGY, false),
        new goapState.state(constants.STATE_ACTOR_HAS_CARRY, true),
        new goapState.state(constants.STATE_ACTOR_HAS_WORK, true)
    ];
    this.postconditions = [
        new goapState.state(constants.STATE_ACTOR_NO_ENERGY, false),
        new goapState.state(constants.STATE_ACTOR_FULL_ENERGY, true),
		new goapState.state(constants.STATE_ROOM_HAS_ENERGY, false),
		new goapState.state(constants.STATE_ROOM_HAS_ENOUGH_ENERGY_FOR_A_WORKER, false),
        new goapState.state(constants.STATE_SPAWN_AND_EXTENSION_ENERGY_FULL, false)
    ];
    this.cost = 2;
...
function depositEnergyToSpawnOrExtensionAction() {
    ...
    this.postconditions = [
        new goapState.state(constants.STATE_ACTOR_NO_ENERGY, true),
		new goapState.state(constants.STATE_ACTOR_FULL_ENERGY, false),
		new goapState.state(constants.STATE_ROOM_HAS_ENERGY, true),
		new goapState.state(constants.STATE_ROOM_HAS_ENOUGH_ENERGY_FOR_A_WORKER, true),
...
function buildWorker() {
    this.preconditions = [
        new goapState.state(constants.STATE_ROOM_HAS_ENOUGH_ENERGY_FOR_A_WORKER, true),
		new goapState.state(constants.STATE_ACTOR_IS_SPAWN, true)
    ];
    this.postconditions = [
        new goapState.state(constants.STATE_ROOM_HAS_A_WORKER, true),
...
function upgradeController() {
    this.preconditions = [
		new goapState.state(constants.STATE_ACTOR_NO_ENERGY, false),
		new goapState.state(constants.STATE_ROOM_CONTROLLER_IS_MAX_LEVEL, false),
		new goapState.state(constants.STATE_ACTOR_HAS_CARRY, true),
        new goapState.state(constants.STATE_ACTOR_HAS_WORK, true)
    ];
    this.postconditions = [
